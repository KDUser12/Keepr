...
min_version = (3, 8)  # 3.8 | major : 3
                      #     | minor : 8


def python_compatiblity() -> None:
    """python_compatiblity Check if the Python version is compatible.

    This function checks whether the Python version of the environment where the program is running is equal to or greater than the minimum recommended version, "min_version". 
    It compares the current version to the minimum version, saves the results.
